...
% Letter body
        ...
        \begin{enumerate}
            ...
            \response{
                ...
                We have referenced the work of d’Ambrosio Alfano et al. (2011) in the manuscript when we justify that the model can be considered accurate if the error between the PMV and the TSV is within $\pm$ 0.5; and we have referenced the work in Section 3.3 measurements errors.\\
                Finally, while we recognised the limitations of the DB2 in section 2.1., we have also highlighted the measures we have taken to mitigate these limitations.
