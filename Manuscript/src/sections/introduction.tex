...
To further complicate this issue, over the course of the last decades, several other formulations of the \ac{pmv} model have been proposed.
...
To our knowledge, no other study compared the accuracy of all the aforementioned PMV models, aside from a conference paper we previously published that stands at the basis of this work.
...
For example, some notable works include, the work from \mycite{Doherty1988} who evaluated the ability of the \ac{pmv} and \ac{set} models to predict several physiological variables (i.e., skin temperature, core temperature, and skin wettedness) under a wide range of still air environments and metabolic rates.
