...
% TODO:
%  azzurrino or golden or marrone
% remove numbers and stop at 97.5 with the box and 2.5
% max ticks on the y line is 3 to 5, in some figure I have 10
\begin{figure*}[htb!]
    \centering
...
% consider limiting the table to PMV = 0 or PMV -1
\begin{table}[htb!]
    \centering
    \input{tables/f1.tex}
