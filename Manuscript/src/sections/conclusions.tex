...
Both models have an accuracy lower or equal than \qty{7}{\percent} when predicting either `warm', `hot', or `cold'.
...
We then recommend tha the \gls{55} should change back the upper value of \ac{met} to \qty{2}{met} as it was in the 2020 version of the standard.
