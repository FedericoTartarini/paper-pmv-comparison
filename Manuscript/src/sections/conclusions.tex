...
Finally, we would like to highlight that the current definition of the \ac{pmv} model ``\ldots to predict the average thermal sensation of a large group of occupants'' is ambiguous.
