...
% todo  could you add the values of F1-macro here as well?
...
This value is lower than random guessing (\qty{14}{\percent}), this means that the models are misleading the users.
...
As mentioned previously, researchers, educators and practitioners worldwide may wonder which model they should use.
...
The very low prediction accuracy of both model formulations, along with the lack of data at the extremes of their applicability limits, suggests that these limits may need to be reconsidered.
Based on our results, we recommend restricting the use of the \ac{pmv} only to values $\lvert \textrm{PMV}\lvert \leq 0.5$.
In other words, we only recommend it for determining whether an environment may be deemed comfortable by a large group of occupants.
