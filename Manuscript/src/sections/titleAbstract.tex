...
%        todo check the results below
        We compared the accuracy of the two \ac{pmv} models, against \var{entries_db_used} thermal sensation votes collected in buildings.
