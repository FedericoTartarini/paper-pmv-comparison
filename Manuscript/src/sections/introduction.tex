...
This, as depicted by \mycite{Humphreys2000}, does not provide sufficient insights and information in determining which model is more accurate in predicting \ac{tsv}.
This is because the \ac{pmv} model has a higher prediction accuracy of sensation close to neutrality. 
Being the ASHRAE Global Thermal Comfort Database II v2.1 an unbalanced dataset and most of the data points are neutral a more detailed analysis as the one we are presenting in this manuscript is needed to compare the accuracy of both formulations.
