...
We calculated the overall bias of the model as previously done by \mycite{Humphreys2002} by subtracting the \ac{pmv} and \ac{pmv-ce} predictions from the self-reported \ac{tsv}.
...
In this paragraph, we refer to the \ac{pmv} model, but the consideration can also be applied to the \ac{pmv-ce} model given its formulation.

\paragraph{Heat Balance Equations and Thermal Sensation Predictions}
...
This amount of heat loss is included in the equation even if a person is in thermal neutrality (feeling comfortable) or has a negative heat gain (feeling cooler than neutral).
...
Fanger created this equation based on a limited dataset collected in a laboratory, which was never updated or revisited~\cite{Fanger1970}.
