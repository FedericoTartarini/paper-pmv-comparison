...
\begin{frontmatter}
    ...
    \begin{abstract}
        ...
        We aim to solve this problem by comparing the accuracy of the main \ac{pmv} formulations against \var{entries_db_used} thermal sensation votes collected in buildings.
