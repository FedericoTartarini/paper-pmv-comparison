...
% todo add the number below, Federico, please specify how many datapoint were removed from the used dataset due to this criteria. Besically, we want to say how many points are out because they are not in the applicability range of the standard. 
This criteria removed XXX datapoints. 
