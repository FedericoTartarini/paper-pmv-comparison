...
\begin{figure*}[htb!]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{Figure a) shows the percentage of \ac{tpv} for each thermal sensation vote.
    ...
    \caption{
        Figure c) shows the percentage of participants who consider the space thermally acceptable for each thermal sensation vote.}
